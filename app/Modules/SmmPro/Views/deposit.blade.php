...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="">
                <input type="number" name="_amount" id="amount" placeholder="Минимум 10 000 SP" min="10000"
                       data-type="number"
    ...
    <div class="row">
        <div class="col-sm-12">
                <span id="pts">
                    <?php echo isset($_GET['funds']) ? (int)$_GET['funds'] : 1; ?>
                </span>
            SP = <span id="sum">
                    <?php echo isset($_GET['funds']) ? (int)$_GET['funds'] : 1; ?>
                </span> сум
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="profile">
                    <form action="https://checkout.paycom.uz" class="payment-form" method="POST">
                        ...
                        <input type="hidden" name="account[userId]" value="{{ Auth()->user()->billing_id }}"/>
                ...
                <div role="tabpanel" class="tab-pane" id="home">
                    <form action="https://my.click.uz/pay/" class="payment-form" method="POST">
                        ...
                        <input type="hidden" name="MERCHANT_TRANS_ID" value="{{ Auth()->user()->billing_id }}">
                        <input type="hidden" name="MERCHANT_SERVICE_ID" value="12564">
                        <input type="hidden" name="MERCHANT_TRANS_NOTE" value="Пополнение баланса на Smm-pro.uz">
                ...
                <div role="tabpanel" class="tab-pane" id="settings">
                    <form action="https://pay.smst.uz/prePay.do" class="payment-form" method="POST">
                        ...
                        <input type="hidden" name="amount"
                               value="<?php echo isset($_GET['funds']) ? (int)$_GET['funds'] * 100 : 0; ?>"/>
                        <input type="hidden" name="personalAccount" value="{{ Auth()->user()->billing_id }}"/>
                ...
                <div role="tabpanel" class="tab-pane" id="messages">
                    <p>Вы можете пополнить свой баланс через любой пункт Paynet - просто назовите сервис SMM-PRO и
                        свой ID - 1.</p>
    ...
    <div class="row">
        <div class="col-sm-12 mt-3">
            ...
            <p>Цены и условия услуг Smm-pro.uz могут быть в любой момент изменены без предварительного уведомления.
                Актуальные условия изложены в описании услуг.
            </p>
            <p>Мы никогда не даем гарантии по скорости и срокам выполнения услуг. Все изложенные в описании числа носят
                лишь статистический характер. Получая информацию о сроках вы узнаете лишь нашу примерную оценку времени.
            </p>
            <h3>Отказ от ответственности
            </h3>
            <p>Smm-pro.uz не несет ответственности за любой ущерб, принесенный вам или вашему бизнесу. Во время нашей
            ...
            <p>Мы стремимся сделать наиболее привлекательную накрутку, но не гарантируем что 100% аккаунтов будет иметь
            ...
            <p>Во время накрутки по большинству услуг мы ориентируемся на имеющееся в инстаграм число подписчиков,
                лайков, просмотров или комментариев. Поэтому, во время накрутки вы не должны использовать каких-либо еще
            ...
            <p>Мы не оказываем поддержку и консультации по вопросам накрутки. Если вы не разбираетесь в тонкостях этого
                процесса - воспользуйтесь услугами специалиста или задавайте вопросы на форуме.
            </p>
            <p>Мы оставляем за собой право не выполнять накрутку и не возвращать средства в случае нарушения вами наших
                условий.
            </p>
            <p>Мы можем в любой момент отказать вам в обслуживании и заблокировать доступ к сайту без объяснения причин.
                Если у вас останутся вопросы или претензии, вы можете сообщить их на нашу почту.
            </p>
            <h3>Гарантия от списания подписчиков
            </h3>
            <p>Любая накрутка подписчиков в инстаграм имеет списания. Размер этих списаний зависит от способа накрутки.
            </p>
            <p>Если в течение гарантийного срока после окончания накрутки у вас будут списания и станет меньше
                ...
                оплаты или дополнительную накруткy. Гарантия действует только при списании подписчиков, накрученных с
                гарантией. Выполнение новой накрутки означает окончание гарантийного срока предыдущей накрутки на ту же
            ...
            <p>Мы серьезно относимся к вашей частной жизни и предоставленной вами информации. Принимаем меры для её
                защиты и гарантируем, что личная информация не будет передаваться третьим лицам. Кроме случаев нарушения
                законодательства.
            </p>
            <p>Условия могут изменяться в любой момент без уведомления. Каждый раз, совершая заказ, вы даете согласие,
